    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TANK', 'Танки'), ('HEALER', 'Хилы'), ('DPS', 'ДД'), ('MERCHANT', 'Торговцы'), ('GUILDMASTER', 'Гилдмастеры'), ('QUESTGIVER', 'Квестгиверы'), ('BLACKSMITH', 'Кузнецы'), ('LEATHERWORKER', 'Кожевники'), ('POTION_MASTER', 'Зельевары'), ('SPELLMASTER', 'Мастера заклинаний')], max_length=20)),
